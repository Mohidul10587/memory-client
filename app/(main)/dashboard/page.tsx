        ...
        <div className="px-6 pb-6">
          <div className="flex items-end justify-between -mt-12 mb-4">
            ...
            <Link href="/dashboard/edit"
              ...
              <Edit className="h-4 w-4" />সম্পাদনা
            </Link>
          </div>
      ...
      {profile && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            {profile.bloodGroup && (
              <InfoRow icon={<Droplets className="h-4 w-4 text-red-500" />} label="রক্তের গ্রুপ" value={BLOOD_GROUP_LABELS[profile.bloodGroup]} />
            )}
...
function InfoRow({ icon, label, value, href }: {
  ...
  if (href) return <a href={href} target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">{content}</a>;
  return content;
}
